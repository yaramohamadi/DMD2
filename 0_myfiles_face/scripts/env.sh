...
eval "$(/export/livia/home/vision/Ymohammadi/miniconda3/ shell.bash hook)"
...
# git submodule set-url third_party/dhariwal https://github.com/yaramohamadi/guided-diffusion
# git submodule sync third_party/dhariwal

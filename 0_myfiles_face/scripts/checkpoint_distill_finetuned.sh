python 0_myfiles_face/scripts/checkpoint_distill_finetuned.py \
  --ckpt 0_myfiles_face/checkpoint_path/metfaces_lr5e-7_bs1_dn3_DMD0_GClsw15e-3__naive_all_ftnaive_ddpmall/checkpoint_best/pytorch_model.bin \
  --out 0_myfiles_face/checkpoints/metfaces_finetune.pt \
  --include-prefix unet. \
  --strip-prefix unet. \
  --show-prefixes

...
export WANDB_PROJECT="SWEEP_GAN_singlehead_datasetsizes"
...
DATASET_SIZES=(10 5 1)
DENOISING_STEPS=(3)

# NEW: GAN adversarial loss sweep
LOSSES=("bce") # "hinge" "wgan"   "LSGAN"

GAN_MULTIHEADS=("")  # "--gan_multihead" to enable


# "hinge" "wgan" 
fmtw () { echo "$1" | sed 's/\./p/g'; }

for GAN_MULTIHEAD in "${GAN_MULTIHEADS[@]}"; do

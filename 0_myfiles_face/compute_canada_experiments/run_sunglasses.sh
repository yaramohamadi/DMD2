...
export WANDB_PROJECT="SUNGLASSES"
...
for lr in "${GEN_LR[@]}"; do
  for i in "${!GEN_CLS_LOSS_WEIGHT[@]}"; do
    ...
    export CHECKPOINT_PATH="0_myfiles_face/checkpoint_path/sunglasses_lr5e-8_bs1_dn3_DMD1_GClsw15e-3__lr5e-8_clw5e-2_glw15e-3/checkpoint_model_043700"

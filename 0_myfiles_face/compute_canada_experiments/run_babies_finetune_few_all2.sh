...
#   [babies]="0_myfiles_face/checkpoint_path/FFHQ_distilled_weights/checkpoint_model_037200/"
#   [cat]="0_myfiles_face/checkpoint_path/FFHQ_distilled_weights/checkpoint_model_037200/"
#   [metfaces]="0_myfiles_face/checkpoint_path/FFHQ_distilled_weights/checkpoint_model_037200/"
#   [sunglasses]="0_myfiles_face/checkpoint_path/FFHQ_distilled_weights/checkpoint_model_037200/"
# )
  ...
  for dd in few; do           # or: for dd in all few; do
    for lr in "${GEN_LRS[@]}"; do
      for i in "${!GEN_CLS_LOSS_WEIGHTS[@]}"; do
        ...
        # Optional per-dataset overrides (uncomment if using the maps above)
        # export RESOLUTION="${RES_BY_DS[$ds]:-256}"
        # export LABEL_DIM="${LABELDIM_BY_DS[$ds]:-0}"

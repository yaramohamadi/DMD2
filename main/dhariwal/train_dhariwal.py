...
class Trainer:
    ...
    def train_one_step(self):
        ...
        if COMPUTE_GENERATOR_GRADIENT:
            generator_loss += self.dmd_loss_weight * generator_loss_dict["loss_dm"]
            ...
            if accelerator.mixed_precision == "fp16":
                ...
                generator_grad_norm = torch.nn.utils.clip_grad_norm_(self.model.feedforward_model.parameters(), self.max_grad_norm)

...
python main/edm/test_folder_edm.py \
    --folder $CHECKPOINT_PATH/pokemon_gan_classifier_genloss3e-3_diffusion1000_lr2e-6_scratch/time_1754942524_seed10 \
    --wandb_name test_pokemon_gan_classifier_genloss3e-3_diffusion1000_lr2e-6_scratch \

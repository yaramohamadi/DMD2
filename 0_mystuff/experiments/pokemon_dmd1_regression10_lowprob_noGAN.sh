...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node 2 --nnodes 1 --master_addr "$MASTER_ADDR" --master_port "$MASTER_PORT" main/edm/train_edm.py \
    ...
    --output_path $CHECKPOINT_PATH/pokemon_dmd1_regression10_0.01lowprob_radius0_1anchor_noGAN \
    --batch_size 20 \
    ...
    --use_fp16 \
    --wandb_name "pokemon_dmd1_regression10_0.01lowprob_radius0_1anchor_noGAN"   \
